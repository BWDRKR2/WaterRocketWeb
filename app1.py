...
def end_fuel(amount1):
    return render_template('main.html', fueling='location.href="http://108.74.158.146/fueled/' + amount1 + '";', counter="<h4>Fueling       </h4>", arm="disabled", unarm="disabled", fuel="disabled", launch="disabled", abort="active")
